...
struct Vao {
    ...
    GLuint addVbo(const void* data, size_t bytes, int location, int size,
                  GLenum dtype = GL_FLOAT, int stride = 0, int offset = 0);
    ...
    static Vao create(const std::vector<VertexBufferDesc>& vertexBuffers,
