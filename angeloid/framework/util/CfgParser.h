...
inline bool parsePair(const std::string& line, size_t start, std::string& key, std::string& val) {
...
inline std::unordered_map<std::string, std::string> parseCfgFile(
